...
zypper --non-interactive ar ${SLES_MIRROR}/Products/SLE-Module-Basesystem/15-SP5/${ARCH}/product?auth=basic sles15sp5-Module-Basesystem-product
zypper --non-interactive ar ${SLES_MIRROR}/Updates/SLE-Module-Basesystem/15-SP5/${ARCH}/update?auth=basic sles15sp5-Module-Basesystem-update
zypper update -y
zypper clean -a
zypper --non-interactive rr --all
